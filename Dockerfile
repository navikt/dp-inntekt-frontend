...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:22@sha256:a022d55d4872830550ca11f47a6a86c4ec1de6f6ff86808bc33e718797d498af AS runtime
WORKDIR /app
